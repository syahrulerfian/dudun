            ...
            <table border="1">
                ...
                foreach ($gaji->index() as $data) {
                    ...
                    <tr>
                        ...
                        <td class="table-light"><a href="show.php?karyawan_id=<?php echo $data['karyawan_id']; ?> " class="btn btn-success">Tampil</a>
                            <a href="edit.php?karyawan_id=<?php echo $data['karyawan_id']; ?>" class="btn btn-danger">Ubah</a>
